...
def test_student_workflow_bad_dialogue_item_type_is_422(client, auth_headers):
    student = make_student(client, auth_headers, "zz_pytest_student_dlg_item")
    response = client.put(
